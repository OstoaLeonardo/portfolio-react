const classNames = 'w-[85%] h-auto text-neutral-600 dark:text-neutral-100 aspect-square'

export function HTML5Icon() {
    return (
        <svg className={classNames} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
            <path fill='currentColor' d='M1.941 1H22.06l-1.098 19.208l-8.96 3.36l-8.962-3.36zM4.06 3l.902 15.792l7.04 2.64l7.038-2.64L19.941 3zm1.61 2h12.66l-.115 2.017L16.495 7H7.787l.193 3.377h10.043l-.405 7.084L12 19.568l-5.618-2.107l-.194-3.388h2.024l.044 1.12l.048.853L12 17.432l3.696-1.386l.21-3.67H6.09z'></path>
        </svg>
    )
}
...
export function JavaScriptIcon() {
    return (
        <svg className={classNames} viewBox='0 0 15 15' xmlns='http://www.w3.org/2000/svg'>
            <path stroke='currentColor' d='M12.5 8v-.167c0-.736-.597-1.333-1.333-1.333H10a1.5 1.5 0 1 0 0 3h1a1.5 1.5 0 0 1 0 3h-1A1.5 1.5 0 0 1 8.5 11m-2-5v5a1.5 1.5 0 0 1-3 0M.5.5h14v14H.5z'></path>
        </svg>
    )
}
