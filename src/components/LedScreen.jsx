    ...
    return (
        <section className='relative w-full row-span-2 uppercase select-none'>
            <div className='w-full h-full max-md:flex max-md:items-center max-md:justify-center flex-col group'>
                ...
                <span className='hidden lg:inline-block absolute top-28 left-28 z-20 text-[9vw] text-white/80 font-archivo-black group-hover:font-outline-2 whitespace-normal leading-none transition-all'>
                    {subtitle}
                </span>
            </div>
            <Dropdown />
